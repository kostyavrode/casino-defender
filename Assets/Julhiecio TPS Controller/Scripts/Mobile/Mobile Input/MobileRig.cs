...
namespace JUTPS.CrossPlataform
{
    ...
    public class MobileRig : MonoBehaviour
    {
        ...
        CrouchButton, RollButton, PickItemButton, EnterVehicleButton, NextWeaponButton, PreviousWeaponButton, RightButton, LeftButton, ForwardButton, BackButton, BrakeButton, PauseButton;
        public void FindButtonsAndTouches()
        {
            ...
            PauseButton = GameObject.Find("PauseButton").GetComponent<ButtonVirtual>();
        }
        private void Update()
        {
